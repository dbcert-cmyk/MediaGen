...
class VertexAIMediaGenerator:
    ...
    def generate_video(
        ...
        try:
            ...
            # Add reference images for character consistency (Solution 1)
            if reference_images and len(reference_images) > 0:
                ...
                for i, ref_img in enumerate(reference_images[:3]):  # Max 3 reference images
                    ...
                    if ref_bytes:
                        ...
                        print(f"🎭 Added reference image {i+1} (type: {ref_type}) for character consistency")

                if ref_image_objects:
                    request_params["reference_images"] = ref_image_objects
